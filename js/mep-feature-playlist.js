...
(function ($) {
	...
	$.extend(MediaElementPlayer.prototype, {
		...
		buildplaylistfeature: function (player, controls, layers, media) {
			...
			//Media session bindings to show next track and previous track function in notification
			if ('mediaSession' in navigator) {
				navigator.mediaSession.setActionHandler('previoustrack', function () { player.playPrevTrack(); });
				navigator.mediaSession.setActionHandler('nexttrack', function () { player.playNextTrack(); });
			}
		},
		...
		playTrack: function (track) {
			...
			// Update Media Metadata on media session to show on wear and notification
			if ('mediaSession' in navigator) {
				navigator.mediaSession.metadata = new MediaMetadata({
					title: track.text(),
					album: track.text(),
					artwork: [
						{ src: 'https://dummyimage.com/96/ff6f00/ffffff&text=Tamil+Radio', sizes: '96x96', type: 'image/png' },
						{ src: 'https://dummyimage.com/128/ff6f00/ffffff&text=Tamil+Radio', sizes: '128x128', type: 'image/png' },
						{ src: 'https://dummyimage.com/192/ff6f00/ffffff&text=Tamil+Radio', sizes: '192x192', type: 'image/png' },
						{ src: 'https://dummyimage.com/256/ff6f00/ffffff&text=Tamil+Radio', sizes: '256x256', type: 'image/png' },
						{ src: 'https://dummyimage.com/384/ff6f00/ffffff&text=Tamil+Radio', sizes: '384x384', type: 'image/png' },
						{ src: 'https://dummyimage.com/512/ff6f00/ffffff&text=Tamil+Radio', sizes: '512x512', type: 'image/png' },
					]
				});
			}
			t.load();
